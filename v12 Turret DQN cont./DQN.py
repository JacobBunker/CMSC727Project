...
thrusts = np.array([0.0,0.0, 0.1,0.1, 0.1,0.1, 0.0,0.0]) #the thrust magnitude for the various thrusters
...
objectType = "Target"
objectName = "ShootMe"
x = 10 * np.random.rand(1,3)[0] #position
sim.createObject(mass, dim, x, q, p, l, objectType, objectName, thrusts, loadtime) #add cube object to bodies
...
plt.scatter(episodeSave, rewardSave, c="g", alpha=0.5, marker='o')
plt.xlabel("Episode")
plt.ylabel("Reward")
